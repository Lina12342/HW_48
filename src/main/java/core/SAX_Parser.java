	...
	public static void main(String[] args) throws Exception {
		...
		DefaultHandler h = new DefaultHandler() {
			...
			public void startElement(String a, String b, String c, Attributes d) throws SAXException {
				...
				if (c.equalsIgnoreCase(element_10)) {handler_10 = true;}
			...
			public void characters(char ch[], int start, int length) throws SAXException {
				...
				if (handler_06) {System.out.println("Normalized:\t " + new String(ch, start, length)); handler_06 = false;}
				if (handler_07) {System.out.println("Database:\t " + new String(ch, start, length)); handler_07 = false;}
				if (handler_08) {System.out.println("Lang:\t " + new String(ch, start, length)); handler_08 = false;}
				if (handler_09) {System.out.println("Country:\t " + new String(ch, start, length)); handler_09 = false;}
				if (handler_10) {System.out.println("Branch:\t " + new String(ch, start, length)); handler_10 = false;}
			}
		};
		p.parse(url, h);
	}
